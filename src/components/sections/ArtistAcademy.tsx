        ...
        >
            ...
            <div ref={textRef} className="relative z-10 max-w-4xl mx-auto px-6">
                ...
                <p className="academy-quote font-serif text-3xl md:text-5xl lg:text-6xl leading-[1.2] text-white/90">
                    ...
                    <span className="italic font-light text-brand-champagne">sondern die Summe aus meisterhafte Wissen und praktischem können. Dafür stehen wir mit unserer Akademie.
                        Möchtest du eintauchen in die Welt der Meisterschaften Beauty Behandlungen, dann bist du bei uns richtig.&rdquo;</span>
                </p>
